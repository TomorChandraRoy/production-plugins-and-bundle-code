...
const General = ({ attributes, setAttributes, device = "desktop" }) => {
  ...
  return (
    <>
    {/* theme SelectControl */}
    {/* <PanelBody className='bPlPanelBody' title={__('Theme', 'b-pricing-card')} initialOpen={false}>
      <SelectControl
        label={__('Theme', 'b-pricing-card')}
        labelPosition='left'
        value={themeStyle}
      ...
      <PanelBody className="bPlPanelBody" title={__("Header Content", "b-pricing-card")} initialOpen={false}>
        <InputControl
          label={__("Title", "b-pricing-card")}
        ...
        <TextareaControl
          label={__("Decription", "b-pricing-card")}
      ...
      <PanelBody
        ...
        title={__("Card Items", "b-pricing-card")}
        initialOpen={true}
      >
      ...
      <PanelBody
        className="bPlPanelBody"
        title={__("Responsive", "b-pricing-card")}
        initialOpen={false}
      >

        <PanelRow>
          <Label className="">{__('Columns', "b-pricing-card")}</Label>
          <Device />
        </PanelRow>
        ...
        />
        <Spacer />
        <UnitControl  label={__('Column Gap:', 'b-pricing-card')} labelPosition='left' value={style?.columnGap} 
