...
export const PricingColumn = ({ attributes, setAttributes, arrKey, index }) => {
    ...
    return (
        <div>
            <Spacer />
            <ToggleControl
                label={__("Highlight Card", "b-pricing-table")}
            ...
            {MinimalPriceCardData[index]?.highlighted && (
                <TextControl
                    ...
                    label={__("Highlight Text", "b-pricing-table")}
            ...
            <Spacer />
            <ToggleControl
                label={__("Button Highlight", "b-pricing-table")}
            ...
            <TextControl
                ...
                label={__("Currency", "b-pricing-table")}
            ...
            <TextControl
                ...
                label={__("Button Name", "b-pricing-table")}
            ...
            <PanelBody className="bPlPanelBody" title={__("Features", "b-pricing-table")} initialOpen={false}>
                <Spacer />
                <ToggleControl
                    label={__("Icon Specific/Global Color ", "b-pricing-table")}
                        ...
                        <div key={featureIndex} className=''>
                            ...
                            {colorToggle
                                ? (
                                    ...
                                    <ColorControl
                                        label={__("Icon Color :", "b-pricing-table")} defaultColor="#53df55"
                                        value={iconColor}
