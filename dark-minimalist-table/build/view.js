...
/***/ "./src/Components/Common/DarkMinimalistTable.js":
/*!******************************************************!*\
  !*** ./src/Components/Common/DarkMinimalistTable.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const DarkMinimalistTable = ({
  attributes,
  setAttributes
}) => {
  const {
    darkMinimalistTableData
  } = attributes;
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("main", {
  ...
  }, darkMinimalistTableData.map((data, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `card-${index} ${data?.popularToggle ? "popular" : "pricing-card"}`,
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: val => setAttributes({
      darkMinimalistTableData: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkMinimalistTableData, val, index, 'title')
    }),
    ...
    className: "plan-name",
    value: data?.title
  }), data.popularToggle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    className: "popular-badge",
    tagName: "span",
    value: data?.popularTitle,
    placeholder: "Enter PopularText",
    onChange: val => setAttributes({
      darkMinimalistTableData: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkMinimalistTableData, val, index, 'popularTitle')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, data?.popularTitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
    tagName: "span",
    className: "popular-badge",
    value: data?.popularTitle
  })))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    placeholder: "Price",
    onChange: val => setAttributes({
      darkMinimalistTableData: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkMinimalistTableData, val, index, 'price')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
    tagName: "span",
    ...
    placeholder: "Price",
    onChange: val => setAttributes({
      darkMinimalistTableData: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkMinimalistTableData, val, index, 'period')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
    tagName: "span",
    ...
    onChange: val => setAttributes({
      darkMinimalistTableData: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkMinimalistTableData, val, index, 'description')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
    tagName: "span",
    ...
    className: "features"
  }, data?.features?.map((feature, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "feature",
    key: i
    ...
    onChange: val => setAttributes({
      darkMinimalistTableData: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkMinimalistTableData, val, index, "features", i, 'title')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
    ...
    className: `buy-button ${data.popularToggle ? "popular-button" : ""}`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    value: data?.buttonText,
    placeholder: "Your Button Text",
    onChange: val => setAttributes({
      darkMinimalistTableData: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkMinimalistTableData, val, index, 'buttonText')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "arrow-icon",
    dangerouslySetInnerHTML: {
      __html: data?.buttonIcon
    }
  })) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, data?.buttonText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: data?.buttonLink || '#',
    className: `buy-button ${data.popularToggle ? "popular-button" : ""}`,
    target: data?.buttonNewTab ? "_blank" : "_self",
    rel: data?.buttonNewTab ? "noopener noreferrer" : undefined
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DarkMinimalistTable);
...
const Style = ({
  ...
  const generateIconFillCSS = () => {
    return darkMinimalistTableData.map((card, index) => card.features.map((feature, i) => `.card-${index} .features .feature .icon-${i} svg {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.pricingTitleTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.priceTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.periodTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.desTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.featureTextTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.buttonTextTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.popularButtonTextTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.popularTitleTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.popularPriceTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.popularPeriodTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.popularDesTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.popularFeatureTextTypo)?.googleFontLink}
	    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.popularButtonTextTyp)?.googleFontLink}


		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(planName, style?.pricingTitleTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(price, style?.priceTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(period, style?.periodTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(description, style?.desTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(featureText, style?.featureTextTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(buyButton, style?.buttonTextTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(popularBadge, style?.popularButtonTextTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(popularPlanName, style?.popularTitleTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(popularPrice, style?.popularPriceTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(popularPeriod, style?.popularPeriodTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(popularDescription, style?.popularDesTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(popularFeatureText, style?.popularFeatureTextTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(popularbuyButton, style?.popularButtonTextTyp)?.styles}
		...
		${pricingCard}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.pricingCardPadding?.desktop))}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.priceCardRadius))}
		}
		${icon} svg{
		...
		${period}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.periodMargin?.desktop))}
		}
		${description}{
		  color: ${style?.desColor};
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.desMargin?.desktop))}
		}
		${features}{
		...
		${buyButton}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.buttonPadding?.desktop))}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.buttonRadius))}
		}
		${buyButton}:hover{
		...
		${popular}{
		   ...
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularPadding?.desktop))}
           ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularRadius))}
		...
		${popularBadge}{
		   ...
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularButtonRadius))}
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularButtonPadding?.desktop))}
		}
        ...
        ${popularPeriod}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularPeriodMargin?.desktop))}
	    }
		${popularDescription}{
		  color: ${style?.popularDesColor};
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularDesMargin?.desktop))}
		}
		...
		${popularbuyButton}{
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularButtonsPadding?.desktop))}
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularButtonRadiuss))}
		}
		...
		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.tabBreakpoint}{
			...
			${pricingCard}{
			  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.pricingCardPadding?.tablet))}
			}
			${period}{
			  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.periodMargin?.tablet))}
			}
			${description}{
			  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.desMargin?.tablet))}
			}
			${buyButton}{
			  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.buttonPadding?.tablet))}
			}
		   ${popular}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularPadding?.tablet))}
		   }
		   ${popularBadge}{
			 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularButtonPadding?.tablet))}
		    }
           ${popularPeriod}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularPeriodMargin?.tablet))}
	        }
		   ${popularDescription}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularDesMargin?.tablet))}
		    }
		   ${popularbuyButton}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularButtonsPadding?.tablet))}
		    }
		}
		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.mobileBreakpoint}{
			...
			${pricingCard}{
			  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.pricingCardPadding?.mobile))}
			}
			${period}{
			  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.periodMargin?.mobile))}
			}
			${description}{
			  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.desMargin?.mobile))}
			}
			${buyButton}{
			  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.buttonPadding?.mobile))}
			}
		   ${popular}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularPadding?.mobile))}
		   }
		   ${popularBadge}{
			 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularButtonPadding?.mobile))}
		    }
           ${popularPeriod}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularPeriodMargin?.mobile))}
	        }
		   ${popularDescription}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularDesMargin?.mobile))}
		    }
		   ${popularbuyButton}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.popularButtonsPadding?.mobile))}
		    }
		}
		${generateIconFillCSS()};
...
/* harmony import */ var _Components_Common_DarkMinimalistTable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/DarkMinimalistTable */ "./src/Components/Common/DarkMinimalistTable.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      className: "pTableDarkMinimalist"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_DarkMinimalistTable__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes
    }))));
