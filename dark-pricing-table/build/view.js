...
/***/ "./src/Components/Common/DarkTable.js":
/*!********************************************!*\
  !*** ./src/Components/Common/DarkTable.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const DarkTable = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, darkPricingTable?.map((data, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index,
    className: `pricing-card-${index} ${data?.popularToggle ? "popular" : "pricing-card"}`
    ...
    onChange: val => setAttributes({
      darkPricingTable: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkPricingTable, val, index, 'popularTitle')
    }),
    ...
    onChange: val => setAttributes({
      darkPricingTable: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkPricingTable, val, index, 'title')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
    ...
    onChange: val => setAttributes({
      darkPricingTable: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkPricingTable, val, index, 'price')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    className: "period",
    ...
    onChange: val => setAttributes({
      darkPricingTable: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkPricingTable, val, index, 'period')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
    ...
    onChange: val => setAttributes({
      darkPricingTable: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkPricingTable, val, index, 'description')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
    tagName: "p",
  ...
  }, data?.features?.map((feature, idx) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pricing-fea-icon"
    ...
    onChange: val => setAttributes({
      darkPricingTable: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkPricingTable, val, index, 'features', idx, 'title')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
    ...
    className: "feature",
    value: feature?.title
  }))))))), data?.buttonName && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: `button ${data?.popularToggle ? "popularButton" : ""}`
    ...
    onChange: val => setAttributes({
      darkPricingTable: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(darkPricingTable, val, index, 'buttonName')
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color']
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DarkTable);
...
const Style = ({
  ...
  const generateIconFillCSS = () => {
    return darkPricingTable.map((card, index) => card.features.map((feature, idx) => `.pricing-card-${index} .pricing-feature .pricing-fea-icon .icon-${idx} svg {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.pricingTitleTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.mostPopularStyle?.pricingPopularTitleTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.mostPopularStyle?.popularButtonTitleTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.pricingPriceTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.mostPopularStyle?.mostPricingPriceTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.periodTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.mostPopularStyle?.mostPeriodTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.desTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.mostPopularStyle?.mostDesTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.mostPopularStyle?.mostFeatureTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.featureTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.buttonTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', style?.mostPopularStyle?.mostButtonTypo)?.googleFontLink}

		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(pricingTitle, style?.pricingTitleTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(popularPricingTitle, style?.mostPopularStyle?.pricingPopularTitleTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(tag, style?.mostPopularStyle?.popularButtonTitleTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(price, style?.pricingPriceTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(popularPrice, style?.mostPopularStyle?.mostPricingPriceTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(period, style?.periodTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(popularPeriod, style?.mostPopularStyle?.mostPeriodTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(description, style?.desTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(popularDescription, style?.mostPopularStyle?.mostDesTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(popularfeature, style?.mostPopularStyle?.mostFeatureTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(feature, style?.featureTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(button, style?.buttonTypo)?.styles}

		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(popularButton, style?.mostPopularStyle?.mostButtonTypo)?.styles}

		${pricingContainer} {
		  max-width:${style?.layoutSize};
		}
		${pricingTableSection}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.priceCardRadius))}
		}
		${pricingTableCard}{
		...
		${pricingCard}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.pricingPadding?.desktop))}
		...
		${period}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.periodMargin?.desktop))}
		}
		${description}{
		...
		${button}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.buttonRadius))};
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.buttonPadding?.desktop))}
		}
		${button}:hover{
		...
		${popular}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostPricingPadding?.desktop))}
		}
        ${tag}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.popularButtonRadius))}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.popularButtonPadding?.desktop))}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.popularButtonMargin?.desktop))}
		}
		...
		${popularPeriod}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostPeriodMargin?.desktop))}
		}
		${popularDescription}{
		...
		${popularButtonn}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostButtonRadius))};
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostButtonPadding?.desktop))}
		...
		@media only screen and (min-width: 641px) and (max-width: 1024px) {
		  ...
		  ${pricingCard}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.pricingPadding?.tablet))}
		    }
		  ${popular}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostPricingPadding?.tablet))}
		    }
		  ${tag}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.popularButtonPadding?.tablet))}
			 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.popularButtonMargin?.tablet))}
		    }
		 ${period}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.periodMargin?.tablet))}
		    }
		 ${popularPeriod}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostPeriodMargin?.tablet))}
		   }
		 ${button}{
             ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.buttonPadding?.tablet))}
		    }
		 ${popularButtonn}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostButtonPadding?.tablet))}
		    }
		 ${popular}{
		...
		@media only screen and (max-width: 641px) {
		  ...
		  ${pricingCard}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.pricingPadding?.mobile))}
		    }
		  ${popular}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostPricingPadding?.mobile))}
		    }
		  ${tag}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.popularButtonPadding?.mobile))}
			 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.popularButtonMargin?.mobile))}
		    }
		  ${period}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.periodMargin?.mobile))}
		    }
		 ${popularPeriod}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostPeriodMargin?.mobile))}
		   }
		 ${button}{
             ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.buttonPadding?.mobile))}
		    }
		 ${popularButtonn}{
		     ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(style?.mostPopularStyle?.mostButtonPadding?.mobile))}
		    }
		 ${popular}{
		     border-top: ${style?.mostPopularStyle?.mostPricingBorderWidth} solid ${style?.mostPopularStyle?.mostPricingBorderColor};
             border-bottom: ${style?.mostPopularStyle?.mostPricingBorderWidth} solid ${style?.mostPopularStyle?.mostPricingBorderColor};
...
/* harmony import */ var _Components_Common_DarkTable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/DarkTable */ "./src/Components/Common/DarkTable.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      className: "bBlocksDarkPricingTable"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_DarkTable__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes
    }))));
